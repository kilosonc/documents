...
2. 开发者在修改配置仓库后，需要将修改推到仓库中，并向 master 分支提交 MR。这时会触发流水线，验证修改是否正确。内部 Gitlab 会有一个机器人，监听到 MR 后，会在 MR下方进行评论，开发者和评审者通过评论与机器人交流，输入`+1`，代表同意，当获得足够的票数之后，机器人会自动合入 MR。这个过程中，
![[Screenshot_20230607_182144.png]]
